        ...
        return(
            <div className='container-fluid' id="buy-page">
                ...
                <Col md={12} className='buy-layer'>
                    <Glyphicon glyph='glyphicon glyphicon-home'> Dashboard/Change-Password</Glyphicon>
                </Col>
            </Row>
            <Row>
                <Col md={1}  ></Col>
                ...
                <Col md={7} className='dashboard-result-box'>
                    <h2 class='dashboard-heading'> Change Password</h2>
                    <div className="font-color">  
                        <form>
                            <Row className='top'>
                                <Col md={12}>
                                    <span className='buy-tab-content'> Old Password: </span>
                            ...
                            <Row className='toptab'>
                                <Col md={12} >
                                    <span className='buy-tab-content'> New Password: </span>
                                    <FormControl id="formControlsText" type="text" label="Text" placeholder=""/>
                                </Col>
                            </Row>
                            ...
                            <Row className='toptab'>
                                <Col md={12}>
                                    <span className='buy-tab-content'> Confrim Password: </span>
                                    <FormControl id="formControlsText" type="text" label="Text" placeholder=""/>
                                </Col>
                            </Row>
